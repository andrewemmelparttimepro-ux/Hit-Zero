# Hit Zero Quality Audit - 2026-05-12

## Executive Summary
- Mode: dry
- Score: 0 / 100
- Checks: 1 pass, 1 warn, 11 fail, 0 skipped
- Findings: 15 total (P0: 1, P1: 12, P2: 2)
- Canary: skipped

## Top Risks
- HZQ-005 | P0 | deploy | Live source smoke errored for hitzero_home: fetch failed (https://thehitzero.net/)
- HZQ-002 | P1 | privacy | 5 first-row fallback references found. (pwa/hit_zero_web/components/HZPrimitives.jsx:239, pwa/hit_zero_web/screens/MockScore.jsx:34, pwa/hit_zero_web/screens/OtherScreens.jsx:721, pwa/hit_zero_web/screens/OtherScreens.jsx:727, pwa/hit_zero_web/screens/Tier1Tier2Screens.jsx:1714)
...
- HZQ-006 | P1 | deploy | Live source smoke errored for mca_home: fetch failed (https://mcaminot.com/)
- HZQ-007 | P1 | deploy | Live source smoke errored for service_worker: fetch failed (https://thehitzero.net/sw.js?v=hzq)
- HZQ-008 | P1 | deploy | Live source smoke errored for client_actions: fetch failed (https://thehitzero.net/hit_zero_web/db/client.js?v=hzq)
- HZQ-009 | P1 | deploy | Live source smoke errored for staff_family_view: fetch failed (https://thehitzero.net/hit_zero_web/db/client.js?v=hzq-viewas)
- HZQ-010 | P1 | deploy | Live source smoke errored for shell_routes: fetch failed (https://thehitzero.net/hit_zero_web/components/HZShell.jsx?v=hzq)
- HZQ-011 | P1 | deploy | Live source smoke errored for family_signup_entry: fetch failed (https://thehitzero.net/hit_zero_web/components/HZShell.jsx?v=hzq-signup)
- HZQ-012 | P1 | deploy | Live source smoke errored for mca_account_entry: fetch failed (https://mcaminot.com/app/Primitives.jsx?v=hzq-signup)

## Check Results
- PASS - supabase_config: https://ldhzkdqznccfgpdvqyfk.supabase.co
- WARN - static_audit: 22 files scanned; 4 findings so far
...
2026/05/12 06:11:22 Access token not provided. Supply an access token by running supabase login or setting the SUPABASE_ACCESS_TOKEN environment variable.


## Raw Artifacts
- docs/audits/2026-05-12-production_data_audit_raw.txt

## Findings
### HZQ-001 | P2 | frontend
- Role: all
- Status: open
- File/Route: pwa/hit_zero_web/screens/OtherScreens.jsx:945, pwa/hit_zero_web/screens/OtherScreens.jsx:956, pwa/hit_zero_web/screens/OtherScreens.jsx:966, pwa/hit_zero_web/screens/OtherScreens.jsx:977, pwa/hit_zero_web/screens/OtherScreens.jsx:1411, pwa/hit_zero_web/screens/OtherScreens.jsx:1423, pwa/hit_zero_web/screens/Roster.jsx:44, pwa/hit_zero_web/screens/Roster.jsx:55
...
- Role: all
- Status: open
- File/Route: pwa/hit_zero_web/components/HZPrimitives.jsx:239, pwa/hit_zero_web/screens/MockScore.jsx:34, pwa/hit_zero_web/screens/OtherScreens.jsx:721, pwa/hit_zero_web/screens/OtherScreens.jsx:727, pwa/hit_zero_web/screens/Tier1Tier2Screens.jsx:1714
...
- Role: all
- Status: open
- File/Route: pwa/hit_zero_web/components/HZShell.jsx:365, pwa/hit_zero_web/components/HZShell.jsx:381, pwa/hit_zero_web/db/client.js:336, pwa/hit_zero_web/screens/PublicBooking.jsx:4, pwa/hit_zero_web/screens/PublicTrial.jsx:4
