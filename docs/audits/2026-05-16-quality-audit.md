# Hit Zero Quality Audit - 2026-05-16
...
2026/05/16 06:41:56 Access token not provided. Supply an access token by running supabase login or setting the SUPABASE_ACCESS_TOKEN environment variable.


## Raw Artifacts
- docs/audits/2026-05-16-production_data_audit_raw.txt
...
- Role: all
- Status: open
- File/Route: pwa/hit_zero_web/components/HZShell.jsx:369, pwa/hit_zero_web/components/HZShell.jsx:385, pwa/hit_zero_web/db/client.js:336, pwa/hit_zero_web/screens/PublicBooking.jsx:4, pwa/hit_zero_web/screens/PublicTrial.jsx:4
